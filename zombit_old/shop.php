...
<html lang="en">
  <head>
    ...
    <meta name="dcterms.created" content="di, 23 apr 2013 17:46:31 GMT">
  ...
  <body>
  <?php
  $_SESSION["koopkogels"] = 1;
  $randkogels = rand(5,25);
  $_SESSION["randkogels"] = $randkogels;
$welhelm = rand(1,100);
if($welhelm <= 13)
	 {
	 $_SESSION["koophelm"] = 1;
	 $randhelm = rand(1,3);
	 $_SESSION["randhelm"] = $randhelm;
	 }
if($welhelm > 13)
	 {
	 $_SESSION["koophelm"] = 0;
...
$_SESSION["koopsigaretten"] = 1;
$randsigaretten = rand(2,3);
$_SESSION["randsigaretten"] = $randsigaretten;
$_SESSION["kooplucifers"] = 1;
$randlucifers = rand(1,2);
$_SESSION["randlucifers"] = $randlucifers;
  ?>
Welkom in de shop! Wat wilt u doen?<br /><br />
<a href="koopshop.php">Ik wil iets kopen</a><br /><br />
<a href="verkoopshop.php">Ik wil iets verkopen</a>
  </body>
</html>